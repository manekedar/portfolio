...
//   return (
//     <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from bg-gray-200 to-[#001b5e]'>
...
//                 {title}
//              </h3>
//              <p className='pb-4 pt-2 font-bold text-blue-700 text-center'>React Js</p>
//              <a href='/'>
