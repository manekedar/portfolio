...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
         <h1 className='py-4 text-4xl font-bold text-center text-[#001b5e] dark:text-white'>Contact</h1>
         <form action="https://getform.io/f/blljgnzb" method='POST' encType='multipart/form-data'>
             <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                 ...
                 <div className='flex flex-col'>
                     ...
                     <input className='border-2 rounded-lg p-3 flex border-gray-300' type="text" name='mobile' />
                 </div>
            </div>
