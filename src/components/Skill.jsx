...
const Skill = () => {
  return (
    <div id='skills' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
      <h1 className='py-4 text-4xl font-bold text-center text-[#001b5e] dark:text-white'>Skills</h1>
      <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
        {skills.map((skill, index) => (
          <div key={index} className='flex items-center text-lg text-gray-700 border-2 rounded-lg p-3 border-gray-300 dark:text-white'>
