...
//     <div id='main'>
//         <img className='w-full h-screen object-cover object-left scale-x-[-1]' src="https://images.pexels.com/photos/5077393/pexels-photo-5077393.jpeg" alt="" />
//         <div className={`w-full h-screen absolute top-0 left-0 ${theme === 'dark' ? 'bg-black/50' : 'bg-white/40'}`}>
//           <div className='max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center'>
//               <h1 className='sm:text-5xl text-4xl font-bold text-gray-800 dark:text-white'>I'm Kedar Mane</h1>
//               <div className='flex flex-col items-center lg:flex-row lg:items-center'>
//                 <img className='w-32 h-32 rounded-full absolute top-10 right-45 lg:top-20 lg:right-90' src="WhatsApp Image 2024-08-02 at 10.22.14 PM.jpeg" alt="Kedar Mane" />
...
//                           <FaTwitter className='cursor-pointer' size={20}/>
//                   </a>
//                   <a href='https://www.instagram.com/kedar_mane_321' target='_blank' rel='noopener noreferrer'>
//                           <FaInstagram className='cursor-pointer' size={20}/>   
//                   </a>
//                   <a href='https://www.facebook.com/share/v3rL2FfHMNfD6572' target='_blank' rel='noopener noreferrer'>
//                           <FaFacebook className='cursor-pointer' size={20} />
//                   </a>
//                   <a href='https://www.linkedin.com/in/kedar-mane-20827b144' target='_blank' rel='noopener noreferrer'>
//                           <FaLinkedin className='cursor-pointer' size={20}/>
...
//           </div>
//         </div>
//         <div className='absolute top-3 right-10 lg:right-20'>
//           <input type="checkbox" className="toggle toggle-warning" onChange={toggleTheme} checked={theme === 'dark'} />
//         </div>
//     </div>
//   );
// };
    ...
    <div id='main'>
        ...
        <div className={`w-full h-screen absolute top-0 left-0 ${theme === 'dark' ? 'bg-black/50' : 'bg-white/40'}`}>
          <div className='max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center'>
              ...
              <div className='flex justify-between pt-6 max-w-[200px] w-full'>
                  <a href='https://x.com/kedarmane321' target='_blank' rel='noopener noreferrer'>
                      <FaTwitter className='cursor-pointer text-gray-800 dark:text-white' size={20} />
                  </a>
                  <a href='https://www.instagram.com/kedar_mane_321' target='_blank' rel='noopener noreferrer'>
                      <FaInstagram className='cursor-pointer text-gray-800 dark:text-white' size={20} />
                  </a>
                  <a href='https://www.facebook.com/share/v3rL2FfHMNfD6572' target='_blank' rel='noopener noreferrer'>
                      <FaFacebook className='cursor-pointer text-gray-800 dark:text-white' size={20} />
                  </a>
                  <a href='https://www.linkedin.com/in/kedar-mane-20827b144' target='_blank' rel='noopener noreferrer'>
                      <FaLinkedin className='cursor-pointer text-gray-800 dark:text-white' size={20} />
                  </a>
              </div>
          </div>
        </div>
